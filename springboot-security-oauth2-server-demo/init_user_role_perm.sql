...
INSERT INTO `tb_perm` VALUES (3001,'PERM_ADMIN_SELECT','管理员查看权限'),(3002,'PERM_ADMIN_DELETE','管理员删除权限'),(3003,'PERM_USER_SELECT','用户查看权限'),(3004,'PERM_USER_DELETE','用户删除权限');
UNLOCK TABLES;
...
INSERT INTO `tb_role` VALUES (2001,'ROLE_ADMIN','管理员'),(2002,'ROLE_USER','用户');
UNLOCK TABLES;
